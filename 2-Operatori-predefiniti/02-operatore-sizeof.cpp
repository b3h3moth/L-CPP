...
int main() {
	...
	// OPERATORE SIZEOF
	// Restituisce la dimensione in byte di un tipo di dato o di un oggetto,
	// il valore di ritorno restituito e' di tipo size_t.
	//
	...
	// l'operatore sizeof inoltre, essendo valutato dal compilatore come se
	// fosse un'espressione costante, puo' essere inserito in ogni punto del
	// programma in cui puo' essere inserita una espressione costante.
