...
int main() {
	...
	cout << "OPERATORI LOGICI"		<< "\n"
		...
		///////////////////////////////////////////////////////////////////////
		cout << "\nGli operatori in alto hanno la precedenza su quelli in basso.\n" << endl;
		cout << "   OPERATORE     " << "          FUNZIONE                     "
			<< "     USO" << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "::               " << " scopo globale                         " 
			<< " ::nome" << endl;
		cout << "::               " << " scopo di classe                       " 
			<< " classe::nome" << endl;
		cout << "::               " << " scopo di namespace                    " 
			<< " namespace::nome" << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << ".                " << " seletori di membro                    " 
			<< " oggetto.membro" << endl;
		cout << "->               " << " seletori di membro                    " 
			<< " puntatore->membro" << endl;
		cout << "[]               " << " subscript                             " 
			<< " variabile[expr]" << endl;
		cout << "()               " << " chiamata di funzione                  " 
			<< " nome(lista_expr)" << endl;
		cout << "()               " << " costruzione di tipo                   " 
			<< " tipo(lista_expr)" << endl;
		cout << "++               " << " incremento postfisso                  " 
			<< " lvalue++" << endl;
		cout << "--               " << " decremento postfisso                  " 
			<< " lvalue--" << endl;
		cout << "typeid           " << " type ID                               " 
			<< " typeid(tipo)" << endl;
		cout << "typeid           " << " type ID run time                      " 
			<< " typeid(tipo)" << endl;
		cout << "const_cast       " << " conversione di tipo                   " 
			<< " const_cast<tipo>(expr)" << endl;
		cout << "dynamic_cast     " << " conversione di tipo                   " 
			<< " dynamic_cast<tipo>(expr)" << endl;
		cout << "reinterpret_cast " << " conversione di tipo                   " 
			<< " reinterpret_cast<tipo>(expr)" << endl;
		cout << "static_cast      " << " conversione di tipo                   " 
			<< " static_cast<tipo>(expr)" << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "sizeof           " << " dimensione oggetto                    " 
			<< " sizeof expr" << endl;
		cout << "sizeof           " << " dimensione tipo                       " 
			<< " sizeof(tipo)" << endl;
		cout << "++               " << " incremento prefisso                   " 
			<< " ++lvalue" << endl;
		cout << "--               " << " decremento prefisso                   " 
			<< " --lvalue" << endl;
		cout << "~                " << " NOT bit a bit                         " 
			<< " ~expr" << endl;
		cout << "!                " << " NOT logico                            " 
		...
		cout << "&                " << " indirizzo di                          " 
			<< " &expr" << endl;
		cout << "()               " << " conversione di tipo                   " 
			<< " (tipo) expr" << endl;
		cout << "new              " << " allocazione oggetto                   " 
			<< " new tipo " << endl;
		cout << "new              " << " allocazione/inizializzazione oggetto  " 
			<< " new tipo(lista_expr) " << endl;
		cout << "new              " << " allocazione/place oggetto             " 
			<< " new (lista_expr) tipo(lista_expr)" << endl;
		cout << "new              " << " allocazione array                     " 
		<< " tutte le forme " << endl;
		cout << "delete           " << " deallocazione oggetto                 " 
			<< " tutte le forme " << endl;
		cout << "delete           " << " deallocazione array                   " 
			<< " tutte le forme " << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "->*              " << " selezione puntatore a membro          " 
			<< " puntatore->*puntatore_a_membro " << endl;
		cout << ".*               " << " selezione puntatore a membro          " 
			<< " oggetto.*puntatore_a_membro " << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		...
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "<<               " << " scorrimento bit a bit a sinistra      " 
			<< " expr << expr" << endl; 
		cout << ">>               " << " scorrimento bit a bit a destra        " 
			<< " expr >> expr" << endl; 
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "<                " << " minore di                             " 
			<< " expr < expr " << endl;
		cout << "<=               " << " minore o uguale a                     " 
		<< " expr <= expr " << endl;
		cout << ">                " << " maggiore di                           " 
			<< " expr > expr " << endl;
		cout << ">=               " << " maggiore o uguale a                   " 
			<< " expr >= expr " << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "==               " << " uguaglianza                           " 
		...
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "?:               " << " Operatore condizionale                " 
			<< " expr ? expr : expr" << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "=                " << " Assegnamento                          " 
			<< " lvalue = expr" << endl;
		cout << "=, *=, /=        " << " Operatori di assegnamento composti    " 
			<< " lvalue *= expr ..." << endl;
		cout << "%=, +=, -=, <<=  " << endl;
		cout << ">>=, &=, |=, ^=  " << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << "throw            " << " Eccezione                             " 
			<< " throw expr" << endl;
		cout << "-----------------" << "---------------------------------------" 
			<< "----------------------------------" << endl;
		cout << ",                " << " Operatore virgola                     " 
			<< " expr, expr" << endl;
