...
int main() {
	...
	cout << "OPERATORI LOGICI"		<< "\n"
		...
		cout << "--               " << " decremento prefisso                   " << " --lvalue" << endl;
		cout << "~                " << " NOT bit a bit                         " << " ~expr" << endl;
		cout << "!                " << " NOT logico                            " << " !expr" << endl;
		cout << "-                " << " meno unario                           " << " -expr" << endl;
		cout << "+                " << " piu' unario                           " << " +expr" << endl;
		cout << "*                " << " dereferenza                           " << " *expr" << endl;
		cout << "&                " << " indirizzo di                          " << " &expr" << endl;
		cout << "()               " << " conversione di tipo                   " << " (tipo) expr" << endl;
		cout << "new              " << " allocazione oggetto                   " << " new tipo " << endl;
		cout << "new              " << " allocazione/inizializzazione oggetto  " << " new tipo(lista_expr) " << endl;
		cout << "new              " << " allocazione/place oggetto             " << " new (lista_expr) tipo(lista_expr)" << endl;
